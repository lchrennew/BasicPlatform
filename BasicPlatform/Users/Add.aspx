<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="Add.aspx.cs" Inherits="BasicPlatform.Users.Add" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div class="page-header">
        <h1>Users <small>Create a new account</small></h1>
    </div>
    <div class="row-fluid">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select multiple="multiple" name="roles" id="roles" class="input-xlarge" role="listbox"
                                size="4">
                                <asp:Repeater runat="server" ID="roles" ItemType="BasicPlatform.Web.Models.Role">
                                    <ItemTemplate>
                                        <option value="<%#Item.Id %>" data-text="<%#Item.Label %>">
                                            <%#HttpUtility.HtmlEncode(Item.Name) %></option>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </select>
                            <uc:PlaceHolder runat="server" Actions="AddRoles">
                                <a href="#" class="btn vertical-bottom" data-invoke="$ajax.modal" data-invoke-target="roles" data-invoke-action="add">
                                ...
                                <table class="table table-striped table-hover table-condensed table-bordered" id="apps">
                                    ...
                                    <tbody>
                                        <asp:Repeater runat="server" ID="apps" ItemType="BasicPlatform.Web.Models.App">
                                            <ItemTemplate>
                                                <tr data-url="<%#Item.Url %>" data-app="<%#Item.Id %>">
                                                    <td>
                                                        <label class="checkbox inline">
                                                            <input type="checkbox" name="<%=apps.ID %>" value="<%#Item.Id%>" /><%#HttpUtility.HtmlEncode(Item.Name)%></label></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:PlaceHolder runat="server" Visible="<%# !string.IsNullOrEmpty(Item.ConnectUrl) %>">
                                                            <input type="text" name="alias" data-control="alias" class="input-medium" disabled="disabled" /></asp:PlaceHolder>
                                                    </td>
                                                    <td>
                                                        <input type="text" name="roles<%#Item.Id%>" data-control="roles" class="span12" disabled="disabled" />
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
