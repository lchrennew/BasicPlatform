<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppAccessDenied.aspx.cs"
    Inherits="BasicPlatform.Auth.AppAccessDenied" %>
        ...
        <div class="row">
            <div class="span12 text-center">
                <p class="alert alert-error">
                    ...
                    You don't have permission to access this app, please re-sign in or return back to your workspace home page.
                </p>
                <asp:LoginView runat="server">
                    <LoggedInTemplate>
                        <a href="/" class="btn btn-large btn-primary"><i class="icon-circle-arrow-left icon-white"></i> Return back to my dashboard</a> <a href="/logout.aspx" class="btn btn-large"><i class="icon-refresh"></i>
                            Sign in with another acount</a> 
                    </LoggedInTemplate>
                </asp:LoginView>
            </div>
        </div>
